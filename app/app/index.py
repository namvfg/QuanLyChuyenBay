...
app.add_url_rule("/staff", "staff_page", controller.staff_page, methods=["POST", "GET"])
...
# ban ve
app.add_url_rule("/staff/selling", "selling", controller.staff_selling, methods=["POST", "GET"])
